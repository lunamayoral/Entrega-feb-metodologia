...
import es.uah.mat.comp.mp.ejd.e3.MovablePoint;
...
class MovablePointTest {
    @Test
    void testToString() {
        es.uah.mat.comp.mp.ejd.e3.Movable p1 = new es.uah.mat.comp.mp.ejd.e3.MovablePoint(5,4,3,9);
        assertEquals("(5,4) speed=(3,9)", p1.toString());
    }

    @Test
    void moveUp() {
        es.uah.mat.comp.mp.ejd.e3.Movable p1 = new es.uah.mat.comp.mp.ejd.e3.MovablePoint(5,11,3,9);
        p1.moveUp();
